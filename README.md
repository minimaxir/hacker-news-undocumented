...
### Setting top color
If a user has **250 Karma**, they can set the color of the top bar. The default is #ff6600. Here's the [complete set](https://news.ycombinator.com/topcolors) of colors users have set.
